...
\section{What is a PhD?} A PhD in the ADCL has two primary objectives:
...
\section{Communication:} During the PhD, you and I will often have complementary sets of knowledge. For example, you will usually understand the low-level details of a problem and your time constraints, while I have a better high-level picture of the research sponsor's goals and the research landscape. Because of this, communication is crucial.
...
\subsection{Work Hours, Vacation / Time Off:} Your GRA/TA contracts contain formal work requirements, but outside of this, there is not a strict requirement for hours worked or vacation days. I expect that you are committed to pursuing the PhD objectives with excellence, and you must be making adequate progress towards completing the PhD and making contributions for our research sponsors. When thinking about how much to work, I encourage students to take a Kantian perspective: would you will that everyone in your position adopt the work patterns that you have? Are you fulfilling your responsibility to the people making your work possible, i.e., in most cases, the taxpayers?

I support students going on vacation, as I believe it is important to rest, however, you must take into account critical deadlines or TA responsibilities. Some researchers like to travel more often and continue to do some work while travelling, while others like to take a shorter amount of time completely off. If you are taking more than a day or two off, please give me a few weeks notice. If you let me know you're taking time completely off, I do not expect you to answer email, etc. 

In keeping with the expectations above, I \emph{recommend} students work as much as they would in a demanding job in the engineering industry and take about the following amount of time off:
\begin{itemize}[nosep, leftmargin=*]
\item University Holidays (individual days when classes are cancelled)
\item Winter Break: About 1 week completely off, 1 additional week of less-intense work
\item About 2 additional weeks completely off (e.g. during Thanksgiving, Spring, and Summer Breaks)
\end{itemize}

\subsection{In-Person Work:} As an ADCL PhD student, you are expected to maintain a physical presence in the lab at CU. The most effective working environment can vary from person to person, but it is beneficial to cross paths with other students, so there is an expectation that you spend some time working in the AERO building. You are expected to attend all lab meetings and individual meetings in person, and, at a minimum, spend at least \textbf{two full days} (or four half days) per week physically in the lab. It is beneficial to spend more than this and many students work from their desk every day.
...
\section{Meetings:} We will have regular one-on-one meetings, usually once per week. For some larger projects, we will have a project meeting (e.g., with undergraduate research assistants, other advisors/collaborators, or other graduate students working on the same/similar project). We will also have regular group meetings. If you need to schedule an extra meeting, you can find my schedule on my website or outlook. Just send me a calendar invitation, and I am usually happy to meet!
