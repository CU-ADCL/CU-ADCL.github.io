...
The requirements of the PhD degree outlined in the department graduate handbook are 
...
\section{Your Role} A PhD is not only as the last step of your education, but also an entry level job in research. You are a member of the CU academic community, and I expect you to take responsibility for achieving the goals above, take initiative to overcome the challenges that arise along the way in self-motivated creative ways, and be resilient when setbacks happen. I want to see you succeed, and I am confident that you can.
